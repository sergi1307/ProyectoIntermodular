...
Per últim, en la pantalla d'usuaris ja siga venedor com comprador podran mirar/comprar productes tant posar-los a la venta, també tens l'opció de filtrar els productes per:
- Preu
- Quantitat
- Categoria
- Distància màxima

Al apretarli a `Afegir producte` s'obrira una finestra en un formulari que conté els següents camps:
- Nom del producte
- Preu
- Descripció
- Imatge del producte
...
## Conclusió
Aquest prototip pot no ser la versió final de l'aplicació, però representa com es podria vore en un futur i/o ajudar en el desenvolupament de les vistes en aquest.
